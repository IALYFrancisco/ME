...
const { getDashboard, getAPIs, getAddProject, getProjects, getTasks, getAddTask, postTask, getDetailsTask, deletTask, putTask, postSubtask, DeleteProject } = require('../Services/DashboardServices')
...
_dashboard_router.post('/project/delete', DeleteProject)
...
_dashboard_router.post('/add-subtask', postSubtask)
